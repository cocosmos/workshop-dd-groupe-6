...
<body>
    ...
    <div class="container">
        ...
        <div class="onlinetext">
            <div id="online" class="solution__title">
                <h2>Sur Internet</h2>
                <img src="media/pictosolution/wifi4.png" width="207px">
            </div>
            
            <div class="case texte_width">
        ...
        <!--At home-->
        <div class="athometext case">

            <div id="athome" class="solution__title">
                <h2>A la maison</h2>
                <img src="media/pictosolution/maison4.png" width="153px">
            </div>
        ...
        <div class="atworktext">
            <div id="atwork" class="solution__title">
                <h2>En Entreprise</h2>
